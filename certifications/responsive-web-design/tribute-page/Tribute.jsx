        ...
        <div id="tribute-info">
          ...
          <ul>
            ...
            <li>
              ...
              in one word, it would be <strong>accessibility</strong>. We wanted
              to make it to where any person anywhere in the world could just go
              somewhere in their browser and immediately start coding and they
              could work through{" "}
            ...
            <li>
              ...
              coding or reviewing the code of other people to make sure everyone
              feels motivated and keeps contributing and that this project keeps
              moving forward.
            </li>
            <li>
              I just had a daughter that is giving me a lot of perspective. My
              heart aches for all the people who only get to spend a little bit
              of time with their kids each day. I'm in an extremely privileged
              position where I can spend as much time with my family as I want
              and for me that is just huge that's worth so much more to me than
              any material asset that I could get or the ability to hop on a
              plane and just jet set around the world.{" "}
              <strong>
                I'd much rather just stay here and hangout with my family.
              </strong>
            </li>
            <li>
              Our ancestors stretch way back into the eons of passing knowledge
              down and it's not some formal handoff. It's just this{" "}
